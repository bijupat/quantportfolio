...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.MIGRATE_HEADING(f"Starting DB-first Transformer training for '{model_name}' on {len(symbols)} symbols..."))
